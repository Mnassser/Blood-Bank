  ...
  <body>
    ...
    <section id="top-nav">
     ...
     <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <a class="nav-logo " href="Home.html"><img class="logo" src="imgs/logo.png"></a>
        ...
        <div class="collapse navbar-collapse" id="navbarText">
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
                <a class="nav-link border-left" href="/test/donations">طلبات التبرع</a>
              </li>
              <li class="nav-item">
          ...
          <span class="navbar-text">
           <a  class="new-account"href="/test/signup">انشاء حــساب جديد</a>
           <a href="/test/login"><button class="btn login-btn shadow">دخول</button></a>
          </span>
        </div>
      </nav>
