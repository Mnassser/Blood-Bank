      ...
      <div class="container">
          ...
          <div class="col-md-6">
              ...
              <div class="input-group mb-2">
                ...
                <input type="text" class="form-control bg-white" id="inlineFormInputGroup" value="محمد محروس" disabled>
              </div>
              <div class="input-group mb-2">
                  <div class="input-group-prepend">
                    <div class="input-group-text">العمر</div>
                  </div>
                  <input type="text" class="form-control bg-white" id="inlineFormInputGroup" value="24" disabled>
                </div>
                <div class="input-group mb-2">
                    <div class="input-group-prepend">
                      <div class="input-group-text">المشفي</div>
                    </div>
                    <input type="text" class="form-control bg-white" id="inlineFormInputGroup" value="الخير الدولية " disabled>
                  </div>
          </div>
          ...
          <div class="col-md-6">
              ...
              <div class="input-group mb-2">
                  ...
                  <input type="text" class="form-control bg-white" id="inlineFormInputGroup" value="A+" disabled>
                </div>
                <div class="input-group mb-2">
                    <div class="input-group-prepend">
                      <div class="input-group-text">عدد الاكياس المطلوبة</div>
                    </div>
                    <input type="text" class="form-control bg-white" id="inlineFormInputGroup" value="5" disabled>
                  </div>
                  <div class="input-group mb-2">
                      <div class="input-group-prepend">
                        <div class="input-group-text">رقم الجوال</div>
                      </div>
                      <input type="text" class="form-control bg-white" id="inlineFormInputGroup" value="+26456894564" disabled>
                    </div>
            </div>
          </div>
